...
if (isset($_POST['newUserSent']))  //if sign up form was submitted
{
    ...
    if ($db->getObjects("users","userEmail", $_POST['mail'], "User") == null)                                   //checking if user's mail already exists
    {
        ...
        $_SESSION['userMessage']="Welcome to PetMatchMaking! You've signed up successfully.";
    ...
    {
        $_SESSION['userMessage']="email is already registered to PetMatchMaking. Please sign in.";
