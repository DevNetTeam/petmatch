...
{
    if ($u->getUserPhone()=="")
        $str.="<div class='red-text-warning'>You haven't entered your phone number yet.</div><br>";
    else if ($petsArray == null)
        $str.="<div class='red-text-warning'>You haven't added any pets yet. Why not join our community?</div><br>";
