...
echo "<h5 class='card-header'>My requests</h5>";
echo "<div class='card-body'>";
echo "<form action='myHelpRequests.php' method=post>";
echo "<button type='submit' class='btn btn-primary' name='addhr'>Add Request</button>";
echo "</form>";
if ($myHR_Array == null)
    echo "<br>Add a request and get some smiles";
echo "</div></div>";
...
if ($myHR_Array == null)
    ...
    foreach ($myHR_Array as $k) //each %k is a helpRequest
    {
        ...
        $str .= "<b>Information:</b> " . $k->getHelpPayment() . "";
