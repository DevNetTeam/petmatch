...
?>
  ...
  <div class="card-header">
    <ul class="nav nav-tabs card-header-tabs pull-right"  id="myTab" role="tablist">
      <li class="nav-item">
       <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">Request overview</a>
      </li>
        <li class="nav-item">
             ...
             <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                 ...
                 if ($help->getHelpEndTime() == "0000-00-00 00:00:00"){
                     if ($help->getHelpStartTime() == "0000-00-00 00:00:00"){
                         ...
                         $helpTimeStr .= "<b>Date: </b>".$help->getHelpStartTime()."<br>";
                 }
                 else
                 ...
                 $str.="<b>Information: </b>".$help->getHelpPayment()."<br><br>";
