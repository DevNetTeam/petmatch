...
<div class="d-flex justify-content-center">
    <div class="card">
        <h5 class="card-header">Editing request</h5>
        <div class="card-body">
<form action="HelpRequestEdit.php" method=post id="newHelpForm" onsubmit="return validateForm()" >
    <label>Pets in this request:</label>
    <?php
    echo $petsStr;
    ?>
    <div class="form-group">
        <br><label>Address of request:</label>
        <div class="form-row">
            <div class="col">
    ...
    <button type="submit" class="btn btn-primary" name="helpRequestEditSent">Update request</button>
</form>
        </div>
    </div>
</div>