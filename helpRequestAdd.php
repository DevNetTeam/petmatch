...
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAZppJHPHXdY3_nK8EWiXtBdrjO8poDxcs-U&libraries=places&callback=initAutocomplete"
        async defer></script>
<script>    <!-- form validation -->
    ...
    var errorMsg = "";
        ...
        else if (document.forms["addHRform"]["addrCountry"].value === "" || document.forms["addHRform"]["addrCountry"].value === "") {
            errorMsg += "Address must contain a country\n";
        }
...
<div class="card">
    ...
    <div class="form-group">
        ...
        <div class="form-row">
            <div class="col">
                <input class="form-control" id="autocomplete" placeholder="Address" onFocus="geolocate()" type="text">
...
<div class="form-group">
    ...
    <button type="submit" class="btn btn-primary" name="helpRequestSent">Publish new request</button>
</form>
    </div>
</div>
</div>
