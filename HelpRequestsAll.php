...
if ($signedInUserPhone == "")
    echo "<br><div class='userMessageRed'>Your profile is not complete. Please edit your profile and enter a phone number.<br> Without a phone number you won't be able to offer request.</div>";
...
else
{
    foreach ($helpRequestsArr as $k) //each %k is a helpRequest
    {
        ...
        $str.="<div class='card-group' id='helpRequestCard'>";
            ...
            if ($k->getHelpEndTime() == "0000-00-00 00:00:00"){
                if ($k->getHelpStartTime() == "0000-00-00 00:00:00"){
                    ...
                    $helpTimeStr .= "<b>Date</b> ".substr($k->getHelpStartTime(), 0, 10)."<br>";
            }
            else
            ...
            $str.="<b>Reward Information:</b> ".$k->getHelpPayment()."<br>";
        ...
        if ($k->getUserID() != $_SESSION['user'] && $dbu->getUserByID($_SESSION['user'])->getUserPhone() != "")
        {
            ...
            {
                $likeButton = "'background-image:url(images/like-empty.png)';";
                $tooltipText = "Liking this help request will leave your details to the publisher so he can get back to you";
                $liked = "no";
            }
            else
            {
                $likeButton = "'background-image:url(images/like-full.png)';";
